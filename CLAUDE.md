...
|-------|-------------|----------------|
| Claude Code | 5/5 | ANTHROPIC_BASE_URL + hooks + JSONL transcripts |
...
- `research-agent-internals.md` — Claude Code/Codex/Copilot/Cursor/Windsurf interception feasibility
...
- `research-summary-claude.md` — 1-page GO brief (Claude synthesis)
